...
                          
                             <img src="checkCode" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;"@click="checkCode()">
<el-input v-model="picLyanzhengma" placeholder="请输入验证码" style="width: 300px" @on-blur="checkLpicma()"></i-input>
                              </div>
